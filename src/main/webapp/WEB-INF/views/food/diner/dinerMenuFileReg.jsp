	...
	<div class="container">
		...
		<main>
			<section>
				...
				<hr>
				<br> <br> <br>
            <form action="/diner/menufileregister.do" method="POST" enctype="multipart/form-data">                
                <div id="image-file-container">
                    ...
                    <div id="image4" class="imageFile">
                        <div id="image_container4" class="image_thumbnail"></div><br>
                        <div id="image_reg_btn4" class = "image_reg_btn">
                            <input type="file" id="image4" name="imagename4"/>
                        </div>
                    </div>
                </div>
                <br><br><br>
	    ...
	    document.addEventListener('DOMContentLoaded', function () {
	        ...
	        submitButton.addEventListener('click', function () {
	            window.location.href = '/diner/menufileregister.do';
	        });
	    });
        ...
        // 파일 선택 버튼 1에 이벤트 리스너 추가
            ...
            document.querySelector('#image4 input[type="file"]').addEventListener('change', function(event) {
                const selectedFile = event.target.files[0];
                const imageContainer = document.querySelector('#image_container4');
